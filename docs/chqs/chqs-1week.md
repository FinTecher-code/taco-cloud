...
**我的答案:** **我的答案:** 选项2（`ArrayList<String> al=new ArrayList<Stri） ✅
...
**我的答案:** **我的答案:** 选项1（BufferedReader可以调用readLine()方法） ❌
