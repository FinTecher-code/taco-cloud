...
**我的答案:** 选项3 ❌
**正确答案:** 选项1（`/etc/ssh/ssh_config` 和 `/etc/ssh/sshd_c）
...
**我的答案:** 选项1 ✅
**正确答案:** 选项1（`dig @ns1.example1.com example2.com`）
...
**我的答案:** 选项3 ✅
**正确答案:** 选项3（clone是fork的升级版本，不仅可以创建进程或者线程，还可以指定创建新的命名）
...
**我的答案:** 选项3 ❌
**正确答案:** 选项4（父进程没有调用wait或waitpid获取子进程信息，导致结束的子进程的描述符存）
...
**我的答案:** 选项2 ❌
**正确答案:** 选项1（一个线程崩溃，不会导致其所属进程的其他线程崩溃）
...
**我的答案:** 选项4 ❌
**正确答案:** 选项2（支持单表多数据源并行加载，不支持多加载机对单表的并行加载，最大化提升加载性能）
